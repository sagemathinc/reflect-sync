...
describeIfCasefold(
  hasCasefoldRoot
    ? "fs capabilities on casefold mount"
    : "fs capabilities on casefold mount [skipped: casefold fixture unavailable]",
  () => {
...
describeIfNotCasefold(
  hasNotCasefoldRoot
    ? "fs capabilities on normal mount"
    : "fs capabilities on normal mount [skipped: normal-mount fixture unavailable]",
  () => {
