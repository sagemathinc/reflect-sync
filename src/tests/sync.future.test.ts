...
describe("rfsync: future capabilities", () => {
  ...
  test.todo(
    "propagate mode-only change (chmod +x) without content change",
    async () => {
      // REQUIREMENTS:
  ...
  test.todo("propagate uid/gid using numeric ids", async () => {
    // REQUIREMENTS:
  ...
  test.todo("preserve hard links (two names, one inode)", async () => {
    // REQUIREMENTS:
  ...
  test.todo(
    "propagate xattrs (and xattr-only change triggers resync)",
    async () => {
      // REQUIREMENTS:
  ...
  test.todo(
    "case-only rename on case-insensitive fs behaves sensibly",
    async () => {
      // REQUIREMENTS:
  ...
  test.todo(
    "sparse file stays sparse (block usage roughly preserved)",
    async () => {
      // REQUIREMENTS:
